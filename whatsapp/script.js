$(function() {
    ...
    var a="";
     ...
     var gm=["GM","GOOD MORNING","GOOD MORNING Achraf Boujjou", "GOOD MORNING Prakash"];
     var bad=["BAD","NOT BAD","USELESS","NOT WORKING","NOT GOOD"];
     var ge=["GOOD EVNG","GOOD EVENING","GOOD EVENING Achraf Boujjou","GOOD EVENING Prakash"];
     ...
     var gaf=["GOOD AFTERNOON","GOOD AFTERNOON Achraf","GOOD AFTERNOON Prakash Singh" ];
    ...
    isInArray(wru, lastmsg)==true?(smsg="I am Prakash Singh", k=smsg):
    ...
    isInArray(bye, lastmsg)==true?(smsg="Thanks for checking my social media platforms.If you loved my content I kindly request you to link, subscribe & follow our social platforms @prakashsingh ", k=smsg,
    ...
    (smsg="Sorry, I didn't understand, please explain it with proper spellings or  If you say so I can search for you. To search, <br> type <q><b> Search Your keyword </b></q> for example type : <b>Search codewithprakash</b>",k="Sorry, I didn't understand, please explain it, with proper spellings, or  If you say, so I can search for you. To search,type,Search Your keyword,for example, type, Search codewithprakash ");
